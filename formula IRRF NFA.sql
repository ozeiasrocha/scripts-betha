...
SELECT totalNota = sum(valor * quantidade) INTO totalNota FROM bethadba.notas_avulsas JOIN bethadba.itens_nota WHERE notas_avulsas.i_notas = p_nr_nota; 
...
ELSE
   SET w_inss = 642.34;         %%teto do inss           
END IF;
