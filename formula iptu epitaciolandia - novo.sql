...
IF(w_tipo IS NULL) AND unidade > 0 THEN
...
MESSAGE string ('ufme ',ufme) TYPE WARNING TO CLIENT;  
MESSAGE string ('areaterr ',areaterr) TYPE WARNING TO CLIENT;  
...
%%MESSAGE string ('unidade ',unidade) TYPE WARNING TO CLIENT;  
...
SET valor_iptu = isnull(vvt,0,vvt)+isnull(vvc,0,vvc);
